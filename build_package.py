...
.hub-tag{{display:inline-block;background:#333132;color:#FFFFFF;padding:3px 9px;font-size:10px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;border-radius:3px;margin-bottom:6px;}}
