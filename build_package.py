...
.hub-tag{{display:inline-block;background:#5C469C;color:#fff;padding:3px 9px;font-size:10px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;border-radius:3px;margin-bottom:6px;}}
...
<div id="hub">
  <div class="hub-header">
    <div>
      ...
      <div class="hub-title"><span style="color:#333132;">Hub</span> <span style="color:#EA0074;">Supply Optimization</span></div>
