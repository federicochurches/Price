...
<div>
<div id="w21-kv-nd" style="font-size:40px;font-weight:700;letter-spacing:-.02em;color:#333132;line-height:1;">{fmt_pct2(pct_w18)}</div>
...
<div style="margin-top:4px;display:flex;align-items:flex-start;gap:14px;flex-wrap:wrap;">
<div>
<div id="ar-nd-kv" style="font-size:40px;font-weight:700;letter-spacing:-.02em;color:var(--ink);line-height:1;">{fmt_pct2(pct_w18)}</div>
<div style="margin-top:5px;display:flex;align-items:center;gap:6px;font-size:10px;color:var(--ink-muted);">vs sem. ant. <span id="ar-nd-wow-pill">{_wow_pill_nd}</span></div>
<div id="ar-nd-traf-line">{_traf_line}</div>
</div>
<div id="ar-nd-band-pill" style="padding-top:4px;">{pill_with_target}</div>
</div>
</div>
{gauge}
<div id="ar-nd-wowbox">{wow_block}</div>
