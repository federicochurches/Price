...
.gap-pill.active{background:#FEE2E2!important;color:#E84040!important;border-color:#E84040!important;}
...
tr.ud-filter-active td:first-child::after{content:' ×';color:#E84040;font-size:10px;cursor:pointer;}
...
.td-neg{color:#E84040;font-size:11px;font-weight:700;text-align:right;}
...
def vs_bar_html(vs):
    color = 'var(--green)' if vs >= 0 else '#E84040'
    sign  = '+' if vs >= 0 else ''
...
def build_channel_tab():
    ...
    for r in ch_tercero:
        ...
        t_rows += (f'<tr{cls} style="cursor:pointer" data-channel="{r["channel"]}" onclick="chDrill(\'{ch_safe}\',this)">'
                   ...
                   f'<td>{fmt_n(r["hoteles"])}</td>'
                   f'<td>{fmt_n(r["destinos"])}</td>'
                   f'<td style="color:#E84040;font-weight:700;">{pct_str}</td></tr>')
...
def build_gap_tab():
    ...
    for r in reg_stats:
        ...
        reg_rows += (
            ...
            f'<td><strong>{reg}</strong></td>'
            f'<td class="td-tot">{fmt_n(tot)}</td>'
            f'<td style="color:#E84040;font-weight:700;">{fmt_n(sin_d)}</td>'
    ...
    <table class="data-table">
      <thead><tr>
        ...
        <th>Total</th>
        <th style="color:#E84040;">Sin Directo</th>
      ...
      <tbody id="gap-tbody">
        <tr class="global-row">
          <td>GLOBAL</td>
          <td>{fmt_n(N)}</td>
          <td style="color:#E84040;font-weight:700;">{fmt_n(int(market_tp))}</td>
          <td class="td-pp">{fmt_n(pp)}</td>
...
<div class="kpi-bar" style="border:1px solid var(--rule);
  ...
  <div style="padding:14px 16px;border-right:1px solid var(--rule);display:flex;flex-direction:column;gap:10px;">
    ...
    <div>
      ...
      <div style="font-size:28px;font-weight:700;color:#E84040;letter-spacing:-.02em;" id="card-gap">{fmt_n(gap)}</div>
      <div style="height:3px;background:var(--rule-soft);border-radius:2px;margin-top:6px;"><div style="height:100%;width:{(100-pct_avance):.1f}%;background:#E84040;border-radius:2px;"></div></div>
      <div style="font-size:11px;font-weight:700;color:#E84040;margin-top:3px;">Pendientes para alcanzar el target</div>
    </div>
  ...
  <div style="padding:16px 18px;border-right:1px solid var(--rule);">
    ...
    {''.join(
      ...
      f'<span style="font-size:13px;font-weight:700;color:#E84040;">{100-int(r["pct_penetracion"]):.1f}%</span>'
      f'</div>'
      f'<div style="height:3px;background:var(--rule-soft);border-radius:2px;">'
      f'<div style="height:100%;width:{min(100,100-int(r["pct_penetracion"])):.1f}%;background:#E84040;border-radius:2px;opacity:.7;"></div>'
      f'</div>'
      f'<div style="font-size:11px;color:#E84040;margin-top:1px;">{fmt_n(int(r["sin_directo"]))}</div>'
      f'</div>'
  ...
  <div style="padding:16px 18px;">
    ...
    {''.join(
      ...
      f'<span style="font-size:13px;font-weight:700;color:#E84040;">{r["pct_sin"]:.1f}%</span>'
      f'</div>'
      f'<div style="height:3px;background:var(--rule-soft);border-radius:2px;">'
      f'<div style="height:100%;width:{min(100,r["pct_sin"]):.1f}%;background:#E84040;border-radius:2px;opacity:.7;"></div>'
      f'</div>'
      f'<div style="font-size:11px;color:#E84040;margin-top:1px;">{fmt_n(int(r["sin_directo"]))}</div>'
      f'</div>'
  ...
  <div style="display:flex;gap:0;align-items:center;flex-wrap:wrap;row-gap:6px;margin-bottom:6px;">
    ...
    <div class="pills-wrap distrib-pills" id="ud-metric-pills" style="border:none;padding:0;gap:4px;">
      ...
      <button class="pill metric-pill gap-pill" data-col="gap" id="btn-gap"
        style="font-size:9px;--pill-on-bg:#FEE2E2;--pill-on-fg:#E84040;--pill-on-bd:#E84040;border-color:#E84040;color:#E84040;"
