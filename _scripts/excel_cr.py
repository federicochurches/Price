...
with open('/home/claude/cr_w18_data.pkl','rb') as f:
    D = pickle.load(f)
...
add_table(ws7, df_corp[['Rk','CorpName','CR_Unicos','Success','Bookings','Errors','Eficacia','ConvRate','BandaEficacia','BandaConvRate']],
          start_row=5, num_formats={'Eficacia':'0.00%','ConvRate':'0.00%','CR_Unicos':'#,##0','Bookings':'#,##0','Errors':'#,##0','Success':'#,##0'},
          banda_col='BandaEficacia')
...
g_dest['Eficacia'] = g_dest['Success']/g_dest['CR_Unicos'].replace(0,1)
...
add_table(ws9, df_chan[['Rk','ExternalProviderName','Grupo','CR_Unicos','Success','Bookings','Errors','Eficacia','ConvRate','BandaEficacia','BandaConvRate']] if 'Grupo' in df_chan.columns else df_chan,
          start_row=5, num_formats={'Eficacia':'0.00%','ConvRate':'0.00%','CR_Unicos':'#,##0','Bookings':'#,##0','Errors':'#,##0','Success':'#,##0'},
          banda_col='BandaEficacia')
