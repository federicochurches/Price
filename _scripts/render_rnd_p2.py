...
def render_demanda_nc():
    ...
    cols = [
        {'key':'hotel','label':'Hotel','width':'minmax(120px,300px)','fmt':lambda r:'','align':'left'},
        {'key':'trafico','label':'Tráfico','width':'62px','fmt':lambda r:fmt_big(r['Trafico'])},
...
def _render_dim_table_rnd(df, dim_col, dim_label, start_idx=0, sb_id=None):
    ...
    import math
    RND_ACCENT = '#EA0074'
    grid = 'minmax(120px,280px) 80px 72px 58px 56px 54px 56px'
