...
var W={mode:'cr',canasta:'global',view:'hotel',reOpen:false};
...
function trow(r){
 ...
 return '<tr style="border-bottom:1px solid var(--rule-soft);">'
  ...
  +'<td style="padding:9px 12px 9px 8px;text-align:right;"><em style="font-style:normal;display:inline-block;font-size:8px;font-weight:700;padding:1px 5px;border-radius:3px;background:'+wb+';color:'+wf+';white-space:nowrap;">'+r[8]+'</em></td>'
  +'</tr>';
}
...
function w22_update(){
 ...
 w22_renderTable('w22-td','w22-td-more',d.dims,false);
...
function w22_iTab(el){
 ...
 row.querySelectorAll('label').forEach(function(t){t.style.background='';t.style.color='';t.style.border='1px solid transparent';t.style.borderBottom='none';t.style.marginBottom='0';});
