...
SEMANAS = ['W16', 'W17', 'W18', 'W19', 'W20', 'W21', 'W22']
...
HIST_DATA = {
    'cr': {
        'eficacia': {
            ...
            'global': [93.27,  93.58,  93.71,  93.30,  93.34,  93.15],
            'op':     [93.72,  94.03,  94.25,  93.87,  93.96,  93.81],
            'cug':    [92.38,  92.69,  92.65,  92.54,  92.28,  92.11],
            'b2c':    [91.82,  92.12,  92.18,  91.49,  92.01,  91.88],
        },
        'convrate': {
            #          W16    W17    W18    W19    W20    W21
            'global': [1.29,  1.15,  1.02,  1.14,  1.63,  1.57],
            'op':     [1.12,  1.00,  0.94,  1.06,  1.59,  1.52],
            'cug':    [2.65,  2.38,  1.82,  2.07,  2.90,  2.74],
            'b2c':    [0.33,  0.30,  0.27,  0.25,  0.39,  0.36],
        },
    },
    'rnd': {
        'nodispo': {
            #          W16    W17    W18    W19    W20    W21
            'global': [3.69,  3.63,  2.84,  2.31,  2.59,  2.63],
            'op':     [3.24,  3.18,  2.62,  1.93,  2.24,  2.28],
            'cug':    [4.40,  4.34,  3.07,  2.73,  2.82,  2.89],
            'b2c':    [4.55,  4.48,  3.68,  3.36,  3.31,  3.38],
        },
        'ipm': {
            #           W16     W17     W18     W19     W20     W21
            'global': [661.0,  574.0,  524.0,  499.0,  677.0,  834.0],
            'op':     [604.0,  523.0,  534.0,  479.0,  688.0,  851.0],
            'cug':    [998.0,  866.0,  659.0,  656.0,  787.0,  962.0],
            'b2c':    [211.0,  183.0,  206.0,  188.0,  248.0,  301.0],
        },
    },
}
...
def get_serie(reporte, metrica, scope, val_actual):
    ...
    # base tiene 6 valores (W16-W21). val_actual es W22.
