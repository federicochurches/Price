...
HIST_DATA = {
    'cr': {
        'eficacia': {
            ...
            'op':     [94.25,  93.87,  93.96,  93.81,  94.68,  94.04,  95.30],
            'cug':    [92.65,  92.54,  92.28,  92.11,  92.74,  95.04,  96.12],
            'b2c':    [92.18,  91.49,  92.01,  91.88,  92.41,  94.14,  95.81],
        },
        'convrate': {
            #          W18    W19    W20    W21    W22    W23    W24
            'global': [1.02,  1.14,  1.63,  1.57,  1.00,  0.84,  0.82],
            'op':     [0.94,  1.06,  1.59,  1.52,  0.92,  0.63,  0.64],
            'cug':    [1.82,  2.07,  2.90,  2.74,  2.12,  1.23,  1.24],
            'b2c':    [0.27,  0.25,  0.39,  0.36,  0.28,  0.18,  0.15],
        },
    },
    'rnd': {
        'nodispo': {
            ...
            'op':     [2.62,  1.93,  2.24,  2.28,  2.26,  3.02,  3.22],
            'cug':    [3.07,  2.73,  2.82,  2.89,  2.87,  2.60,  2.79],
            'b2c':    [3.68,  3.36,  3.31,  3.38,  3.36,  3.35,  3.28],
        },
        'ipm': {
            #           W18     W19     W20     W21     W22     W23     W24
            'global': [524.0,  499.0,  677.0,  834.0,  653.0,  534.0,  611.0],
            'op':     [534.0,  479.0,  688.0,  851.0,  667.0,  334.0,  395.0],
            'cug':    [659.0,  656.0,  787.0,  962.0,  952.0,  872.0, 1041.0],
            'b2c':    [206.0,  188.0,  248.0,  301.0,  298.0,  228.0,  254.0],
        },
    },
