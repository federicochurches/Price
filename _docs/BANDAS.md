...
| **Súper Crítica** | `#2D2828` gris oscuro | `#E8E6E3` gris claro | `#9B2222` | `#8A8377` |
| **Sin Conversión** | `#5F5E5A` gris oscuro | `#F2EEE6` crema | `#8A8377` | `#8A8377` |

> **Súper Crítica** es la única banda sin color saturado — gris claro para reducir contraste, borde rojo oscuro para comunicar severidad. Barra gauge también gris (#8A8377) — coherente con el badge.  
