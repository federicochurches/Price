...
**Versión W23 · Junio 2026 · HTML unificado + Hub v2 visual + Mail v4 rediseñado**
...
5. render_mail_v3.py                 → Mail_WNN.html  (v4.0 — Weekly KPIs · Availability + Connectivities)
...
**Última actualización:** W23 · Junio 2026
**Última limpieza:** W23-pre — rediseño Mail v4.0 (Weekly KPIs · Availability + Connectivities, sin alertas ni plan de acción)
**Pipeline W22:** histórico W16–W22 (7pts) · fix puntos canvas · compatibilidad dataset CR sin Successful
