...
```
Archivos:
- `rates-nodispo/week-17/RatesNoDispo_Reporte_Editorial.html`
- `rates-nodispo/week-17/Analisis_Rates_NoDispo_7d.xlsx`
...
```
Archivos:
- `checkrates/week-17/CheckRates_Reporte_Editorial.html`
- `checkrates/week-17/Analisis_Checkrates_7d.xlsx`
