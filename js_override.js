...
/* W26+: sin col WoW tráfico — 4 cols: nombre · tráfico · métrica · wow
   Header: [<span vacío=nombre>, Tráfico(col1), Métrica(col2), WoW(col3)]
   Array r: col1=r[5](traf), col2=r[7](val), col3=r[8](wow_pp) */
var _KPI_RCOLS_CR  = {1:5, 2:7, 3:8};
var _KPI_RCOLS_RND = {1:5, 2:7, 3:8};
var _KPI_RCOLS = _KPI_RCOLS_CR;

/* Grid CSS por métrica — 4 cols */
var _KPI_GRID = {
